...
<body>
     ...
     //consulta lançamento
     $consulta = $cn->query('select codHq, nomeHq, vl_preco, qtdEstoque, ds_capa from vmHQ where sg_lancamento = "S"');
     ?>
     ...
     <div class="container-fluid">
      ...
      <?php while ($exibe = $consulta->fetch(PDO::FETCH_ASSOC)){ ?>  
        <div class="col-sm-3">
          ...
          <div><h4><b><?php echo mb_strimwidth ($exibe ['nomeHq'],0,30,'...'); ?></b></h4></div>
