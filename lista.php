...
// se a sessão id estiver vazia ou se a sessão estatus for diferente de adm entao execute
	...
	$consulta = $cn->query("SELECT * from tbHQ");
...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 15px;">
		...
		<div class="col-sm-5"><h4 style="padding-top:20px"><?php echo $exibe['nomeHq']; ?></h4></div>
		<div class="col-sm-2" style="padding-top:20px">
		
			
		<a href="frmalterar.php?id=<?php echo $exibe['codHq'];?>&id2=<?php echo $exibe['codCategoria'];?>&id3=<?php echo $exibe['codAutor'];?>">
		...
		<a href="excluir.php?id=<?php echo $exibe['codHq']; ?>">	
