...
<body>
    ...
    //variável categoria
     ...
     //consulta 
     $consulta = $cn->query("select codHq, nomeHq, vl_preco, ds_capa, qtdEstoque from vmHQ where descrCategoria = '$cat'");
     ?>
     ...
     <div class="container-fluid">
      ...
      <?php while ($exibe = $consulta->fetch(PDO::FETCH_ASSOC)){ ?>  
        <div class="col-sm-3">
          ...
          <div><h4><b><?php echo mb_strimwidth ($exibe ['nomeHq'],0,25,'...'); ?></b></h4></div>
