...
try {  // try para tentar inserir
	...
	$inserir=$cn->query("INSERT INTO tbHQ(numIsbn, codCategoria, nomeHq, codAutor, numPag, vl_preco, qtdEstoque, descr_resumo_hq, ds_capa, sg_lancamento) VALUES ('$isbn', '$cd_cat', '$nome_livro', '$cd_autor', '$nopag', '$preco', '$qtde', '$resumo', '$img_nome1', '$lanc')");
